...
router.get('/home', function(req, res){
	...
	productModel.getAllhome(function(result){
		...
		if(!req.session.user){
			res.render('home/home', {products: result, promotion: promotion, categories: categories});
		}
		else{
			res.render('customer/home', {products: result, promotion: promotion, categories: categories});
		}
